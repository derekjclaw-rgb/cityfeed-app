      ...
      <div className="grid grid-cols-2 gap-3 mb-6">
        {[
          ...
          <button
            ...
            style={
              role === option.value
                ? { border: '1px solid #7ecfc0', backgroundColor: 'rgba(126,207,192,0.08)', color: '#2b2b2b' }
                : { border: '1px solid #e0e0d8', backgroundColor: '#fff', color: '#888' }
            }
          >
            <option.icon className="w-5 h-5" style={{ color: role === option.value ? '#7ecfc0' : '#aaa' }} />
            <div>
    ...
    <div className="min-h-screen flex items-center justify-center px-6 pt-20" style={{ backgroundColor: '#f0f0ec' }}>
      <div className="w-full max-w-md">
        ...
        <p className="text-center text-sm mt-6" style={{ color: '#888' }}>
          ...
          <Link href="/login" className="font-medium transition-opacity hover:opacity-80" style={{ color: '#7ecfc0' }}>
            Sign in
          </Link>
        </p>
      </div>
