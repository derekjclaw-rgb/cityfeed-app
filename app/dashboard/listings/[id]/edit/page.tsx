...
import { isStaticCat, classifyCategory, printDefault, resolveRequiresPrint } from '@/lib/categories'
              ...
              <div>
                ...
                <div className="space-y-2">
                  <button
                    ...
                    style={!form.requires_print ? { border: '2px solid #7ecfc0', backgroundColor: 'rgba(126,207,192,0.05)' } : { border: '1px solid #e0e0d8', backgroundColor: '#fff' }}
                  >
                    <span className="font-medium block" style={{ color: '#2b2b2b' }}>Digital upload</span>
                  ...
                  <button
                    ...
                    style={form.requires_print ? { border: '2px solid #7ecfc0', backgroundColor: 'rgba(126,207,192,0.05)' } : { border: '1px solid #e0e0d8', backgroundColor: '#fff' }}
                  >
                    <span className="font-medium block" style={{ color: '#2b2b2b' }}>Printed materials</span>
