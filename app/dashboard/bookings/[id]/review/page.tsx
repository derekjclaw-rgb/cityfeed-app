    ...
    return (
      <div className="min-h-screen flex items-center justify-center pt-20" style={{ backgroundColor: 'var(--cream, #f0f0ec)' }}>
        <div className="text-center max-w-sm">
          ...
          <h2 className="text-xl font-bold mb-2" style={{ color: 'var(--charcoal, #2b2b2b)' }}>Review Submitted!</h2>
    ...
    return (
      <div className="min-h-screen flex items-center justify-center pt-20" style={{ backgroundColor: 'var(--cream, #f0f0ec)' }}>
        <div className="text-center max-w-sm">
          ...
          <h2 className="text-xl font-bold mb-2" style={{ color: 'var(--charcoal, #2b2b2b)' }}>Already Reviewed</h2>
    ...
    <div className="min-h-screen pt-20 px-6 pb-12" style={{ backgroundColor: 'var(--cream, #f0f0ec)' }}>
      <div className="max-w-lg mx-auto">
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            <h1 className="text-2xl font-bold" style={{ color: 'var(--charcoal, #2b2b2b)' }}>Leave a Review</h1>
        ...
        <div className="rounded-2xl p-8" style={{ backgroundColor: '#fff', border: '1px solid var(--border, #e0e0d8)', boxShadow: '0 1px 4px rgba(0,0,0,0.06)' }}>
          <form onSubmit={handleSubmit} className="space-y-6">
            {/* Star Rating */}
            <div>
              <label className="block text-sm font-semibold mb-3" style={{ color: 'var(--charcoal, #2b2b2b)' }}>{reviewLabel}</label>
              <div className="flex items-center gap-2">
                {[1, 2, 3, 4, 5].map(n => (
                  ...
                  >
                    <Star
                      className="w-8 h-8"
                      fill={n <= (hoverRating || rating) ? 'var(--mint, #7ecfc0)' : 'none'}
                      style={{ color: n <= (hoverRating || rating) ? 'var(--mint, #7ecfc0)' : 'var(--border, #e0e0d8)' }}
                    />
                  </button>
                ))}
                {rating > 0 && (
            ...
            {/* Comment */}
            <div>
              <label className="block text-sm font-semibold mb-2" style={{ color: 'var(--charcoal, #2b2b2b)' }}>Your Review</label>
              <textarea
                value={comment}
